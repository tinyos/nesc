...
Atomic sections should be short; to help meet this requirement, \nesc
forbids calling commands or signaling events inside atomic statements.  The
following constructions are also forbidden inside atomic statements (but
may be allowed in future versions of \nesc): \kw{goto}, \kw{return},
\kw{break}, \kw{continue}, \kw{case}, \kw{default} and labels.
